...
typedef enum
{
    ...
    CMD_GET_SINGLE_COUNT_BASE = 0x9000,
    CMD_GET_TX_EXCESS_COLLISION_EVENT,
    CMD_GET_TX_LATE_COLLISION_EVENT,
    CMD_GET_TX_SINGLE_COLLISION_EVENT,
    CMD_GET_TX_MULTI_COLLISION_EVENT,
    CMD_GET_TX_DEFERRED_EVENT,
    CMD_GET_TX_DROP_FRAMES,
    CMD_GET_TX_PACKETS_DISCARDS,
    CMD_GET_TX_BYTES_CNT_LO,
    CMD_GET_TX_PKTS_CNT,
    CMD_GET_TX_BOARD_PKTS_CNT,
    CMD_GET_TX_MULTI_PKTS_CNT,
    CMD_GET_TX_CRC_FRAMES_CNT,
    CMD_GET_TX_64BYTE_PKTS_CNT,
    CMD_GET_TX_65_127BYTE_PKTS_CNT,
    CMD_GET_TX_128_255BYTE_PKTS_CNT,
    CMD_GET_TX_256_511BYTE_PKTS_CNT,
    CMD_GET_TX_512_1023BYTE_PKTS_CNT,
    CMD_GET_TX_1024_1518BYTE_PKTS_CNT,
    CMD_GET_RX_OVERFLOW_FRAME_CNT,
    CMD_GET_RX_ALIGNMENT_ERROR_CNT,
    CMD_GET_RX_OVERSIZE_PKTS_CNT,
    CMD_GET_RX_LACK_DROP_CNT,
    CMD_GET_RX_PKTS_DISCARDS_CNT,
    CMD_GET_RX_DROP_FRAMES_CNT,
    CMD_GET_RX_BYTES_CNT_LO,
    CMD_GET_RX_PKTS_CNT,
    CMD_GET_RX_BOARD_PKTS_CNT,
    CMD_GET_RX_MULTI_PKTS_CNT,
    CMD_GET_RX_CRC_FRAMES_CNT,
    CMD_GET_RX_64BYTE_PKTS_CNT,
    CMD_GET_RX_64_127BYTE_PKTS_CNT,
    CMD_GET_RX_128_255BYTE_PKTS_CNT,
    CMD_GET_RX_256_511BYTE_PKTS_CNT,
    CMD_GET_RX_512_1023BYTE_PKTS_CNT,
    CMD_GET_RX_1024_1518BYTE_PKTS_CNT,
    CMD_GET_RX_1519_MAXBYTE_PKTS_CNT,
    CMD_GET_RX_FRAGMENT_ERROR_CNT,
    CMD_GET_RX_JABBER_ERROR_CNT,
    CMD_GET_RX_UNDER_SIZE_PKTS_CNT,
...
typedef struct mt7530_switch_api_cnt_s
{
    ...
    u32 SingleCnt;
    u32 TxPacketsDiscards;
    u32 TxBoardPktsCnt;
    u32 RxLackDropCnt;
    u32 RxPktsDiscardsCnt;
    u32 RxBoardPktsCnt;
...
#define REG_MFC_CPU_PORT_OFFT		(4)
#define REG_MFC_CPU_PORT_LENG		(3)
#define REG_MFC_CPU_PORT_RELMASK	(0x00000007)
#define REG_MFC_CPU_PORT_MASK		(REG_MFC_CPU_PORT_RELMASK << REG_MFC_CPU_PORT_OFFT)

#define REG_MFC_CPU_EN_OFFT		(7)
#define REG_MFC_CPU_EN_LENG		(1)
#define REG_MFC_CPU_EN_RELMASK	(0x00000001)
#define REG_MFC_CPU_EN_MASK		(REG_MFC_CPU_EN_RELMASK << REG_MFC_CPU_EN_OFFT)

#define REG_MFC_UNU_FFP_OFFT		(8)
#define REG_MFC_UNU_FFP_LENG		(8)
#define REG_MFC_UNU_FFP_RELMASK	(0x000000ff)
#define REG_MFC_UNU_FFP_MASK		(REG_MFC_UNU_FFP_RELMASK << REG_MFC_UNU_FFP_OFFT)

#define REG_MFC_UNM_FFP_OFFT		(16)
#define REG_MFC_UNM_FFP_LENG		(8)
#define REG_MFC_UNM_FFP_RELMASK	(0x000000ff)
#define REG_MFC_UNM_FFP_MASK		(REG_MFC_UNM_FFP_RELMASK << REG_MFC_UNM_FFP_OFFT)

#define REG_MFC_BC_FFP_OFFT		(24)
#define REG_MFC_BC_FFP_LENG		(8)
#define REG_MFC_BC_FFP_RELMASK	(0x000000ff)
#define REG_MFC_BC_FFP_MASK		(REG_MFC_BC_FFP_RELMASK << REG_MFC_BC_FFP_OFFT)
