# ATF/u-boot artifact recipes for both SoC families, lifted from the
# upstream mediatek image/filogic.mk and airoha image/an7581.mk device
# recipes (which this target does not include).
